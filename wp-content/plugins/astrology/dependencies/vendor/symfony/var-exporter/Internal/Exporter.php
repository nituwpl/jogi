...
class Exporter
{
    ...
    public static function prepare($values, $objectsPool, &$refsPool, &$objectsCount, &$valuesAreStatic)
    {
        ...
        foreach ($values as $k => $value) {
            if (\is_resource($value)) {
                throw new \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException(\get_resource_type($value) . ' resource');
            }
            $refs[$k] = $objectsPool;
            if ($isRef = !($valueIsStatic = $values[$k] !== $objectsPool)) {
                ...
                if ($value instanceof \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Reference && 0 > $value->id) {
                    $valuesAreStatic = \false;
                    ++$value->count;
                    continue;
                }
                $refsPool[] = [&$refs[$k], $value, &$value];
                $refs[$k] = $values[$k] = new \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Reference(-\count($refsPool), $value);
            }
            if (\is_array($value)) {
                if ($value) {
            ...
            if (isset($objectsPool[$value])) {
                ++$objectsCount;
                $value = new \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Reference($objectsPool[$value][0]);
                goto handle_value;
            }
            $class = \get_class($value);
            $reflector = \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$class] ?? \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class);
            ...
            $proto = \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class];
            if (($value instanceof \ArrayIterator || $value instanceof \ArrayObject) && null !== $proto) {
                ...
                \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class, \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class], \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]);
            } elseif ($value instanceof \SplObjectStorage && \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class] && null !== $proto) {
                ...
                $value = new \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Reference($id);
                goto handle_value;
            }
    ...
    public static function export($value, $indent = '')
    {
        ...
        if ($value instanceof \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Reference) {
            if (0 <= $value->id) {
                return '$o[' . $value->id . ']';
            }
            if (!$value->count) {
        ...
        if ($value instanceof \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Values) {
            $code = $subIndent . "\$r = [],\n";
        ...
        if ($value instanceof \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry) {
            return self::exportRegistry($value, $indent, $subIndent);
        }
        if ($value instanceof \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Hydrator) {
    ...
    private static function exportRegistry(\Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry $value, string $indent, string $subIndent) : string
    {
        $code = '';
        $serializables = [];
        $seen = [];
        $prototypesAccess = 0;
        $factoriesAccess = 0;
        $r = '\\' . \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::class;
        $j = -1;
        foreach ($value as $k => $class) {
            ...
            if (!\Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            ...
            $c = '[' . self::export($class) . ']';
            if ($seen[$class] ?? \false) {
                if (\Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
                    ++$prototypesAccess;
                    $code .= 'clone $p' . $c;
                } else {
                    ++$factoriesAccess;
    ...
    private static function exportHydrator(\Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Hydrator $value, string $indent, string $subIndent) : string
    {
        $code = '';
    ...
    private static function getArrayObjectProperties($value, array &$arrayValue, $proto) : array
    {
        ...
        $reflector = \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector] ?? \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($reflector);
