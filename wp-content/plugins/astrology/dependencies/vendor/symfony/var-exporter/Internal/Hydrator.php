...
class Hydrator
{
    ...
    public $value;
    public $wakeups;
    public function __construct(?\Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Registry $registry, ?\Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Internal\Values $values, array $properties, $value, array $wakeups)
    {
    ...
    public static function getHydrator($class)
    {
        ...
        if (!\class_exists($class) && !\interface_exists($class, \false) && !\trait_exists($class, \false)) {
            throw new \Prokerala\Astrology\Vendor\Symfony\Component\VarExporter\Exception\ClassNotFoundException($class);
        }
