...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Simple\FilesystemCache::class, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Adapter\FilesystemAdapter::class, \Prokerala\Astrology\Vendor\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use FilesystemAdapter and type-hint for CacheInterface instead.
 */
class FilesystemCache extends \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Simple\AbstractCache implements \Prokerala\Astrology\Vendor\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait;
