...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Simple\TraceableCache::class, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Adapter\TraceableAdapter::class, \Prokerala\Astrology\Vendor\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use TraceableAdapter and type-hint for CacheInterface instead.
 */
class TraceableCache implements \Psr\SimpleCache\CacheInterface, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\PruneableInterface, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\ResettableInterface
{
    private $pool;
    private $miss;
    private $calls = [];
    public function __construct(\Psr\SimpleCache\CacheInterface $pool)
    {
        $this->pool = $pool;
    ...
    private function start(string $name) : \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Simple\TraceableCacheEvent
    {
        $this->calls[] = $event = new \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Simple\TraceableCacheEvent();
        $event->name = $name;
