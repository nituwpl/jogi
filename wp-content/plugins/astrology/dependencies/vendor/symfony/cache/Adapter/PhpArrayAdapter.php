...
class PhpArrayAdapter implements \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Adapter\AdapterInterface, \Prokerala\Astrology\Vendor\Symfony\Contracts\Cache\CacheInterface, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\PruneableInterface, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\ResettableInterface
{
     ...
     */
    public function __construct(string $file, \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
    ...
    {
        if (!$fallbackPool instanceof \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Adapter\AdapterInterface) {
            $fallbackPool = new \Prokerala\Astrology\Vendor\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
        }
