...
{
    private $get;
    public function __construct(\Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\OptionsResolver $optionsResolver)
    {
        $this->get = \Closure::bind(function ($property, $option, $message) {
            /** @var OptionsResolver $this */
            if (!$this->isDefined($option)) {
                throw new \Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException(\sprintf('The option "%s" does not exist.', $option));
            }
            if (!\array_key_exists($option, $this->{$property})) {
                throw new \Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\NoConfigurationException($message);
            }
