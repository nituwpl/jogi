...
class DigestAuthMiddleware implements \Prokerala\Astrology\Vendor\Buzz\Middleware\MiddlewareInterface
{
    private $username;
    private $password;
    private $realm;
     ...
     */
    private function parseServerHeaders(\Psr\Http\Message\ResponseInterface $response) : void
    {
