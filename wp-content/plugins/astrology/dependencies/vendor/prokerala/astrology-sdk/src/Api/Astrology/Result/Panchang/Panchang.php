...
final class Panchang implements \Prokerala\Api\Astrology\Result\ResultInterface
{
     ...
     */
    public function __construct($vaara, array $nakshatra, array $tithi, array $karana, array $yoga, \DateTimeInterface $sunrise, \DateTimeInterface $sunset, \DateTimeInterface $moonrise, \DateTimeInterface $moonset)
    {
        $this->vaara = $vaara;
