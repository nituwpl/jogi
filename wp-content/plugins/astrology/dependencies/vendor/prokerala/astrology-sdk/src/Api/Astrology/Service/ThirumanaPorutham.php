...
final class ThirumanaPorutham
{
    ...
    public function __construct(\Prokerala\Common\Api\Client $client)
    {
        ...
        $this->basicResponseTransformer = new \Prokerala\Api\Astrology\Transformer(\Prokerala\Api\Astrology\Result\HoroscopeMatching\ThirumanaPorutham::class);
        $this->advancedResponseTransformer = new \Prokerala\Api\Astrology\Transformer(\Prokerala\Api\Astrology\Result\HoroscopeMatching\AdvancedThirumanaPorutham::class);
    }
    /**
