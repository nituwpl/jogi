...
$psr17Factory = new \Prokerala\Astrology\Vendor\Nyholm\Psr7\Factory\Psr17Factory();
$httpClient = new \Prokerala\Astrology\Vendor\GuzzleHttp\Client();
$authClient = new \Prokerala\Common\Api\Authentication\Oauth2($clientId, $clientSecret, $httpClient, $psr17Factory, $psr17Factory);
$client = new \Prokerala\Common\Api\Client($authClient, $httpClient, $psr17Factory);
