...
class Request extends \Prokerala\Astrology\Vendor\Slim\Psr7\Message implements \Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($method, \Psr\Http\Message\UriInterface $uri, \Prokerala\Astrology\Vendor\Slim\Psr7\Interfaces\HeadersInterface $headers, array $cookies, array $serverParams, \Psr\Http\Message\StreamInterface $body, array $uploadedFiles = [])
    {
