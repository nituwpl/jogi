...
use function substr;
use function trim;
class Headers implements \Prokerala\Astrology\Vendor\Slim\Psr7\Interfaces\HeadersInterface
{
    /**
     * @var array
     */
     ...
     * {@inheritdoc}
     */
    public function addHeader($name, $value) : \Prokerala\Astrology\Vendor\Slim\Psr7\Interfaces\HeadersInterface
    {
        ...
        if (isset($this->headers[$normalizedName])) {
            ...
            $this->headers[$normalizedName] = new \Prokerala\Astrology\Vendor\Slim\Psr7\Header($originalName, $normalizedName, $values);
        }
        return $this;
    }
    /**
     * {@inheritdoc}
     */
    public function removeHeader(string $name) : \Prokerala\Astrology\Vendor\Slim\Psr7\Interfaces\HeadersInterface
    {
     ...
     * {@inheritdoc}
     */
    public function setHeader($name, $value) : \Prokerala\Astrology\Vendor\Slim\Psr7\Interfaces\HeadersInterface
    {
        [$values, $originalName, $normalizedName] = $this->prepareHeader($name, $value);
     ...
     * {@inheritdoc}
     */
    public function setHeaders(array $headers) : \Prokerala\Astrology\Vendor\Slim\Psr7\Interfaces\HeadersInterface
    {
        $this->headers = [];
