...
class UploadedFile implements \Psr\Http\Message\UploadedFileInterface
{
    ...
    {
        if ($fileNameOrStream instanceof \Psr\Http\Message\StreamInterface) {
    ...
    public function getStream()
    {
        ...
        if (!$this->stream) {
            $this->stream = (new \Prokerala\Astrology\Vendor\Slim\Psr7\Factory\StreamFactory())->createStreamFromFile($this->file);
        }
        return $this->stream;
    }
    /**
