...
class UriFactory implements \Psr\Http\Message\UriFactoryInterface
{
    ...
    public function createUri(string $uri = '') : \Psr\Http\Message\UriInterface
    {
        ...
        return new \Prokerala\Astrology\Vendor\Slim\Psr7\Uri($scheme, $host, $port, $path, $query, $fragment, $user, $pass);
    }
    /**
     ...
     * @return Uri
     */
    public function createFromGlobals(array $globals) : \Prokerala\Astrology\Vendor\Slim\Psr7\Uri
    {
        // Scheme
        ...
        return new \Prokerala\Astrology\Vendor\Slim\Psr7\Uri($scheme, $host, $port, $requestUri, $queryString, '', $username, $password);
    }
}
